...
namespace BibleQuiz
{
	public partial class Form1 : Form
	{
		...
		string[][] question = new string[][]{
			...
			new string[]{ "下雨天時總是先看到閃電才聽到雷聲，那是因為？", "在月球上十公斤重的人，回到地球上會是幾公斤？", "大肚魚是用什麼方式繁殖的？", "彈塗魚在陸上活動時，是用什麼在呼吸？", "氣象局在預測２４小時累積雨量時到達多少毫米，就會發布『大豪雨特報』？", "ㄧ天當中的哪個時候，公園的空氣『含氧量』最高？", "正常人體體細胞有多少條染色體？", "小蜜蜂跳著８字舞是想告訴同伴，香甜的蜂蜜就在？", "蜘蛛會吐絲結網捕捉獵物，那他所吐的絲其實是？", "水蠆（ㄔㄞˋ）是哪一種昆蟲的小時候？","豬籠草和毛氈苔主要藉由捕食昆蟲以獲得該地區缺乏的何種營養素？","當天空出現彎曲彩虹的時候最外層的顏色是？","地球與太陽之間的距離有多少公里？","地殼中含量最高的元素是?" },
			new string[]{ "台灣最小的市是「台北永和」，請問最小的鄉鎮是哪裡？", "請以北至南依序排列台灣名山？", "台語的『胖』指的是麵包，這個發音最早原自？", "小明一家人想去洗世界上少有的海底溫泉，她們應該去哪裡？", "台灣諺語頂港有名聲，下港有出名請問頂港、下港是用什麼來分界？", "稱為『玫瑰之國』的國家為何者?", "世界上地勢最低的國家是：","請問石灰岩地形又稱為什麼地形?","巴西的首都是哪座城市？" },
			new string[]{ "請問2次世界大戰中的軸心國成員為哪3國?", "請問一日三餐是從何時開始?", "“五十步笑百步”出自：","請問八國聯軍為哪八國?","在古希臘，象徵婚姻幸福的標誌是一個什麼形狀？","'地動儀'是誰製作的?","台灣有''福爾摩沙''之稱，是當初哪一國人說出的?" },
			new string[]{ "捷運的英文縮寫是MRT，那請問捷運的英文全名是什麼？", "白雪公主叫Snow White，請問白馬王子叫什麼？", "The sun rises ___ the east. 空格處應填入？", "Sheep feed ___ grass.中間應填入？", "Ｋｅｔｃｈｕｐ的意思是什麼？", "海綿寶寶最愛的寵物是誰？", "媽咪是許多人對媽媽的暱稱，以下何者是美式媽咪的正確拼字？", "以下哪個選項屬於人體『器官』？", "被踩到腳時，中文我們會說『哎喲』，英文該怎麼說？", "以下那一個數字最大？","請說出五種電器的英文" },
			new string[]{ "在速限５ ０公里 以下路段，發生汽車車禍，應將三角警告牌放在車輛後方幾公尺？", "迪士尼經典卡通人物米老鼠養的寵物叫什麼名字？", "人人愛用的FACEBOOK請問成立於何時?", "『紫外線指數』的英文縮寫是什麼？", "以下哪些作品不是宮崎駿的作品？", "教育部至2010年開始訂有「祖父母節」，請問是哪一天?", "人民的保母－警察，他身上配戴的階級胸章位在？", "ＣＰＲ練習對象『甦醒安妮』，她的名稱由來是因為發明者？", "如果把一個成人的全部血管連接起來，其長度接近多少公里？", "飛沫傳染是一種直接傳染途徑，以下那種疾病不是經由飛沫傳染？","華氏溫標規定，一個標准大氣壓下，純水的沸點為","聯合國旗幟圖案是一雙橄欖枝襯托著整個地球，這一圖案取材於哪個故事？","珊瑚婚是指結婚多少周年？" },
			//
			new string[]{ "排球1895年始於那個國家？", "請問NBA籃球規則中規定個人犯規幾次即畢業離場？", "職籃規則中規定，團隊犯規每節超過幾次則要罰球兩次？", "桌球比賽中發球觸網球有過則?", "排球比賽中隊伍上有位身穿不同顏色衣服的球員為何?", "請問棒球比賽中游擊手代號為何?", "請問飛盤比賽中一隊正規出場先發有幾人", "躲避球規則中球員接到球後必須幾秒內出手?", "女排的球網有多高？", "跑步比賽被喻為世界最快的男人請問是何者?", "請問奧運五環為哪五色", "請問2004年奧運在哪裡舉辦?","鐵人三項比賽中，自行車項目的距離為幾公里？" },
			...
			//時事
			new string[]{ "請問今年在舉重58公斤級以抓舉107公斤、挺舉142公斤，總和249公斤，拿下我國本屆世大運舉重金牌，並在挺舉項目打破世界紀錄的台灣女將是誰？", "一週以來，毒雞蛋風波持續由彰化延燒到台南、高雄、屏東、台中、南投，累計有14所中小型蛋雞場的雞蛋檢出____成分超標。台灣食品安全促進協會理事長姜至剛也強調，_____超標不是中毒。由於大部份蛋場都沒有檢驗出超標，少數民眾接觸到低劑量的_____，對於民眾健康影響不大。請問近日毒雞蛋風波所含超標之成分為何？", "何人有''旋渦老人''之稱?" },
			//美術
			new string[]{ "請問下列何者並非色光三原色？", "請問畢卡索為哪一個畫派？", "在文學界，但丁、佩脫拉克、薄伽丘，被稱為「文藝復興三巨星」、「文壇三傑」。在藝術界，15世紀後期至16世紀前半期，義大利文藝復興運動達到鼎盛，出現了「美術三傑」或「畫壇三傑」。請問下列何者並非藝術界的「文藝復興三傑」？", "被稱為“交響樂團的心臟”的是", "被稱為“第七藝術”的是" },
			//神隱少女
